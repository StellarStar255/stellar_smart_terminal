...
TRANSLATIONS = {
    ...
    "alert.menu_edit": {"zh": "编辑输出提醒规则…", "en": "Edit Output Alert Rules…"},
    "alert.edit_title": {"zh": "输出提醒规则", "en": "Output Alert Rules"},
    "alert.edit_label": {"zh": "每行一条正则表达式；清空并确定 = 恢复默认规则", "en": "One regular expression per line; save empty to restore defaults"},
    "alert.rules_saved": {"zh": "已保存 {count} 条提醒规则", "en": "Saved {count} alert rules"},
    "alert.output_matched": {"zh": "输出命中提醒规则：{pattern}", "en": "Output matched alert rule: {pattern}"},
    ...
    "settings.import_title": {"zh": "导入设置", "en": "Import Settings"},
    "settings.export_done": {"zh": "已导出 {count} 项设置到：\n{path}\n\n注意：文件包含 LLM API Key 等敏感信息，请按私密文件保管。", "en": "Exported {count} settings to:\n{path}\n\nNote: the file contains sensitive data (LLM API keys). Treat it as private."},
    "settings.export_failed": {"zh": "操作失败：{error}", "en": "Operation failed: {error}"},
    "settings.import_confirm": {"zh": "导入将覆盖本机的同名设置（预设、主题、快捷键等）。\n机器相关设置（目录历史、窗口布局）不受影响。\n\n继续导入？", "en": "Importing will overwrite matching settings on this machine (presets, theme, shortcuts, ...).\nMachine-specific settings (directory history, window layout) are not affected.\n\nContinue?"},
    "settings.import_done": {"zh": "已导入 {count} 项设置。\n\n重启应用后全部生效。", "en": "Imported {count} settings.\n\nRestart the app for all of them to take effect."},
    "settings.import_invalid": {"zh": "这不是 Stellar 的设置导出文件。", "en": "This is not a Stellar settings export file."},
    ...
    "shortcuts.act.zoom_in": {"zh": "放大字体（终端/编辑器）", "en": "Zoom In (terminal/editor)"},
    "shortcuts.act.zoom_out": {"zh": "缩小字体（终端/编辑器）", "en": "Zoom Out (terminal/editor)"},
    ...
    # ===== main_window_menus.py - 菜单栏 =====
    "menu.file": {"zh": "文件", "en": "File"},
    "menu.view": {"zh": "视图", "en": "View"},
    "menu.terminal": {"zh": "终端", "en": "Terminal"},
    "menu.help": {"zh": "帮助", "en": "Help"},
    "menu.new_window": {"zh": "新建窗口", "en": "New Window"},
    "menu.open_folder": {"zh": "打开文件夹（工作目录）…", "en": "Open Folder (Working Directory)…"},
    "menu.open_file": {"zh": "打开文件…", "en": "Open File…"},
    "menu.open_file_title": {"zh": "在编辑器中打开文件", "en": "Open File in Editor"},
    "menu.recent_dirs": {"zh": "最近的文件夹", "en": "Recent Folders"},
    "menu.recent_dirs_empty": {"zh": "（暂无）", "en": "(none yet)"},
    "menu.export_session": {"zh": "导出会话…", "en": "Export Session…"},
    "menu.show_log": {"zh": "日志面板", "en": "Log Panel"},
    "menu.stop_session": {"zh": "停止会话", "en": "Stop Session"},
    "menu.clear_terminal": {"zh": "清屏", "en": "Clear Terminal"},
    "menu.pasted_images": {"zh": "粘贴的图片…", "en": "Pasted Images…"},
    "menu.open_vscode": {"zh": "在 VS Code 中打开", "en": "Open in VS Code"},
    "menu.open_cursor": {"zh": "在 Cursor 中打开", "en": "Open in Cursor"},
    "menu.manage_presets": {"zh": "管理命令预设…", "en": "Manage Command Presets…"},
    "menu.llm_config": {"zh": "LLM 配置…", "en": "LLM Configuration…"},
    "menu.github": {"zh": "GitHub 项目主页", "en": "GitHub Project Page"},
    "menu.about": {"zh": "关于 Stellar Smart Terminal", "en": "About Stellar Smart Terminal"},
    "menu.about_title": {"zh": "关于", "en": "About"},
    "menu.about_text": {"zh": "Stellar Smart Terminal v{version}\n\n面向 AI 编程助手的智能终端。\n{url}", "en": "Stellar Smart Terminal v{version}\n\nA smart terminal built for AI coding assistants.\n{url}"},
    ...
    "llm.config_list_label": {"zh": "配置列表", "en": "Configs"},
    "llm.edit_label": {"zh": "配置详情", "en": "Details"},
    "llm.new_tooltip": {"zh": "新建配置", "en": "New config"},
    "llm.delete_tooltip": {"zh": "删除选中配置", "en": "Delete selected config"},
    "llm.delete_confirm_title": {"zh": "删除配置", "en": "Delete Config"},
    "llm.delete_confirm": {"zh": "确定删除配置 “{name}”？", "en": "Delete config \"{name}\"?"},
    "llm.role_label": {"zh": "用途:", "en": "Roles:"},
    "llm.chip_default": {"zh": "★ 默认", "en": "★ Default"},
    "llm.chip_completion": {"zh": "✎ 补全", "en": "✎ Completion"},
    "llm.chip_git": {"zh": "⎇ Git", "en": "⎇ Git"},
    "llm.set_default_tooltip": {"zh": "默认使用此配置（点选其他配置可转移，不可直接取消）", "en": "Use this config by default (transfer by checking another config)"},
    ...
    "llm.advanced": {"zh": "高级参数", "en": "Advanced"},
    "llm.tag_default": {"zh": "默认", "en": "Default"},
    "llm.tag_completion": {"zh": "补全", "en": "Completion"},
    "llm.tag_git": {"zh": "Git", "en": "Git"},
    "llm.export_json": {"zh": "导出 JSON", "en": "Export JSON"},
    "llm.import_json": {"zh": "导入 JSON", "en": "Import JSON"},
    ...
    "toolbar.gui_font_tooltip": {"zh": "GUI 界面字体大小（Auto=跟随系统默认；缩放快捷键只作用于终端/编辑器，不影响界面）", "en": "GUI font size (Auto=system default; zoom shortcuts affect only the terminal/editor, not the UI)"},
    ...
    "git.generate_no_config_msg": {"zh": "请先点击工具栏的魔法帽按钮配置大模型 API（API URL、Key、模型）。", "en": "Click the wizard-hat button in the toolbar to configure an LLM API (URL, key, model) first."},
    ...
    "editor.md_preview_tooltip": {"zh": "Markdown 预览（点击切换 渲染/源码）。预览是只读的，不会改动文件内容。", "en": "Markdown preview (click to toggle rendered/source). The preview is read-only and never modifies the file."},
    "editor.html_preview_tooltip": {"zh": "在系统浏览器中预览此 HTML 文件（有未保存的修改会先保存）。", "en": "Preview this HTML file in the system browser (unsaved changes are saved first)."},
    "editor.ai_toggle_tooltip": {"zh": "AI 行内补全（输入停顿后出现灰字建议；Tab 接受，Esc 取消，Alt+\\ 手动触发）。使用工具栏魔法帽按钮里配置的默认 LLM API。", "en": "AI inline completion (ghost suggestion after you pause typing; Tab to accept, Esc to dismiss, Alt+\\ to trigger). Uses the default LLM API configured under the wizard-hat button."},
    ...
    "remote.edit_host_ok": {"zh": "保存", "en": "Save"},
    "remote.edit_host_failed": {"zh": "保存失败：\n{error}", "en": "Save failed:\n{error}"},
    "remote.delete_host": {"zh": "删除", "en": "Delete"},
    "remote.delete_host_title": {"zh": "删除主机", "en": "Delete Host"},
    "remote.delete_host_confirm": {"zh": "确定要删除主机 “{alias}” 吗？（会从 ~/.ssh/config 移除）", "en": "Delete host “{alias}”? (removes it from ~/.ssh/config)"},
    "remote.delete_host_failed": {"zh": "删除失败：\n{error}", "en": "Delete failed:\n{error}"},
    ...
    "transfer.state_skipped_user": {"zh": "已跳过", "en": "Skipped"},
    ...
    "history.search_placeholder": {"zh": "全局搜索：在所有历史会话的命令与输出中查找…", "en": "Global search: find in commands & output of all sessions..."},
    "history.search_running": {"zh": "搜索中…", "en": "Searching..."},
    "history.search_hits": {"zh": "{count} 条命中", "en": "{count} hits"},
    "history.col_snippet": {"zh": "命中片段", "en": "Match"},
    ...
    "tab.merge_split_menu": {"zh": "并入当前标签分屏", "en": "Merge into Current Tab as Split"},
    "tab.merge_split_h": {"zh": "左右分屏（放右侧）", "en": "Side by side (on the right)"},
    "tab.merge_split_v": {"zh": "上下分屏（放下方）", "en": "Stacked (at the bottom)"},
    "status.merge_split_done": {"zh": "已并入分屏，当前标签共 {count} 个终端", "en": "Merged as split — {count} terminals in this tab"},
    ...
    "status.ai_need_llm_config": {"zh": "AI 补全已开启，但还没配置 LLM API —— 请点工具栏魔法帽配置后再用", "en": "AI completion enabled, but no LLM API configured — set it up via the wizard-hat button first"},
    ...
    "remote_paste.connect_title": {"zh": "上传到远端", "en": "Upload to remote"},
    "remote_paste.connect_msg": {"zh": "终端正连着 {host}，但 Remote 面板没有连到这台机器，图片没法上传。\n\n现在连接 {host} 并上传这张图片？", "en": "This terminal is connected to {host}, but the Remote panel is not, so the image cannot be uploaded.\n\nConnect to {host} now and upload the image?"},
    "remote_paste.btn_connect": {"zh": "连接并上传", "en": "Connect and upload"},
    "remote_paste.btn_local": {"zh": "用本地路径", "en": "Use local path"},
    ...
    # ===== 首次启动互动教程 =====
    "onboarding.menu_item": {"zh": "新手教程", "en": "Tutorial"},
    "onboarding.counter": {"zh": "第 {current} / {total} 步", "en": "Step {current} of {total}"},
    "onboarding.next": {"zh": "下一步", "en": "Next"},
    "onboarding.prev": {"zh": "上一步", "en": "Back"},
    "onboarding.skip_step": {"zh": "跳过此步", "en": "Skip this step"},
    "onboarding.skip_tour": {"zh": "退出教程", "en": "Exit tutorial"},
    "onboarding.finish": {"zh": "完成", "en": "Done"},
    "onboarding.hint_done": {"zh": "✓ 做得好，马上进入下一步", "en": "✓ Nice, moving on"},
    "onboarding.welcome.title": {"zh": "欢迎使用 Stellar Smart Terminal", "en": "Welcome to Stellar Smart Terminal"},
    "onboarding.welcome.body": {"zh": "花两分钟手把手认识一遍主要功能。每一步都可以直接上手试，也可以随时退出；以后从「帮助 › 新手教程」能再看一遍。", "en": "Take two minutes for a hands-on walk through the main features. Try each step for real, or exit any time; you can reopen this later from Help › Tutorial."},
    "onboarding.dir.title": {"zh": "工作目录", "en": "Working directory"},
    "onboarding.dir.body": {"zh": "这里决定新终端在哪个文件夹里打开。输入或粘贴路径后点 Switch 切换；下拉箭头列出最近用过的目录；Browse… 打开文件夹选择框。右侧显示当前生效的目录。", "en": "This decides which folder a new terminal opens in. Type or paste a path and click Switch; the caret lists recently used directories; Browse… opens a folder picker. The current directory is shown on the right."},
    "onboarding.quick_launch.title": {"zh": "⚡ 快速切目录（很多人没发现它）", "en": "⚡ Quick Launch (easy to miss)"},
    "onboarding.quick_launch.body": {"zh": "标签栏右端这个闪电按钮，点开是最近目录列表：选一个就在那个目录新建标签页并自动执行预设；也可以直接粘贴路径按回车。按住 Shift 点选会在新窗口打开。", "en": "The lightning button at the right end of the tab bar opens your recent directories: pick one to open a new tab there and auto-run the preset, or paste a path and press Enter. Shift-click an entry to open it in a new window."},
    "onboarding.quick_launch.hint": {"zh": "👉 现在点一下闪电按钮试试", "en": "👉 Click the lightning button now"},
    "onboarding.new_tab.title": {"zh": "新建标签页", "en": "New tab"},
    "onboarding.new_tab.body": {"zh": "加号在当前工作目录新建一个终端标签页（快捷键 Ctrl+T / ⌘T）。标签可以拖动排序、拖出窗口变成独立窗口、双击改名，右键还有更多操作。", "en": "The plus button opens a new terminal tab in the current working directory (Ctrl+T / ⌘T). Tabs can be dragged to reorder, dragged out of the window to detach, double-clicked to rename, and right-clicked for more."},
    "onboarding.new_tab.hint": {"zh": "👉 点一下加号新建一个标签页", "en": "👉 Click the plus button to open a tab"},
    "onboarding.split.title": {"zh": "分屏", "en": "Split panes"},
    "onboarding.split.body": {"zh": "Split 左右分屏，V-Split 上下分屏，Close Split 关掉当前窗格。按住 Shift 点是切分整个标签页而不是当前窗格。窗格之间的把手可以拖动，右键把手还能交换位置、切换方向。", "en": "Split divides side by side, V-Split top and bottom, Close Split closes the current pane. Shift-click splits the whole tab instead of the focused pane. Drag the handle between panes to resize; right-click it to swap or flip the direction."},
    "onboarding.split.hint": {"zh": "👉 点一下 Split 试试分屏", "en": "👉 Click Split to try it"},
    "onboarding.panels.title": {"zh": "侧边面板：文件 / Git / 远程", "en": "Side panels: files, Git, remote"},
    "onboarding.panels.body": {"zh": "Explorer 打开文件浏览器和内置编辑器；Git 是源代码管理面板，可以暂存、提交、切分支、看差异；Remote 管理 SSH 主机和远端文件。三个面板同时只显示一个，再点一次收起。", "en": "Explorer opens the file browser with a built-in editor; Git is the source-control panel for staging, committing, switching branches and viewing diffs; Remote manages SSH hosts and remote files. Only one panel shows at a time; click again to hide it."},
    "onboarding.panels.hint": {"zh": "👉 点 Explorer 打开文件面板", "en": "👉 Click Explorer to open the file panel"},
    "onboarding.navigator.title": {"zh": "终端窗口列表", "en": "Terminal window list"},
    "onboarding.navigator.body": {"zh": "勾选后左侧出现所有终端窗口和标签的列表：可以搜索、点击跳转、拖动排序。列表底部的 Compact 是紧凑模式，Quick Close 允许一键关闭，Embed 决定它嵌在窗口里还是独立浮动在最前面。", "en": "Tick it to show a list of every terminal window and tab on the left: search, click to jump, drag to reorder. At the bottom, Compact switches to a dense layout, Quick Close enables one-click closing, and Embed chooses between docking it in the window or floating it on top."},
    "onboarding.palette.title": {"zh": "命令面板 ⌘K", "en": "Command palette ⌘K"},
    "onboarding.palette.body": {"zh": "记不住按钮在哪时用它：输入几个字就能搜到所有功能和快捷键，回车直接执行。", "en": "When you can't remember where a button is: type a few letters to find any feature or shortcut, then press Enter to run it."},
    "onboarding.palette.hint": {"zh": "👉 按 Ctrl+K / ⌘K，或点一下搜索框", "en": "👉 Press Ctrl+K / ⌘K, or click the search box"},
    "onboarding.presets.title": {"zh": "预设", "en": "Presets"},
    "onboarding.presets.body": {"zh": "预设是一组预先写好的命令（比如激活环境、进入项目、启动 Claude Code），一行一条。选好后新标签页会自动执行；Start / Stop 手动启停当前标签里的预设；Manage 里可以新建和编辑。", "en": "A preset is a list of commands to run automatically (activate an environment, cd into a project, launch Claude Code…), one per line. New tabs run the selected preset; Start / Stop run or stop it in the current tab; Manage creates and edits presets."},
    "onboarding.images.title": {"zh": "粘贴图片", "en": "Pasting images"},
    "onboarding.images.body": {"zh": "直接往终端里粘贴截图，图片会存成文件并把路径填进去，方便发给 Claude Code 等工具。Image @prefix 给路径加 @ 前缀（Gemini CLI 需要）；Image to CWD 把图片存到当前目录的 .images/ 下而不是缓存目录。", "en": "Paste a screenshot straight into the terminal: it is saved as a file and the path is inserted, ready for tools like Claude Code. Image @prefix adds an @ before the path (needed by Gemini CLI); Image to CWD saves into .images/ under the current directory instead of a cache folder."},
    "onboarding.tools.title": {"zh": "常用工具", "en": "Everyday tools"},
    "onboarding.tools.body": {"zh": "VS Code / Cursor 用对应编辑器打开当前目录；Log 显示应用日志面板；Export 导出终端内容；History 搜索所有终端的命令历史；Clear 清屏；Images 查看本会话粘贴过的图片。", "en": "VS Code / Cursor open the current directory in that editor; Log shows the app log panel; Export saves terminal content; History searches command history across all terminals; Clear clears the screen; Images lists the images pasted this session."},
    "onboarding.theme.title": {"zh": "主题", "en": "Theme"},
    "onboarding.theme.body": {"zh": "Theme 切换整套配色，深色、浅色都有，对所有窗口生效；Tint 给 Dock 图标加上主题色，多开几个不同主题的窗口时一眼能认出来。", "en": "Theme switches the whole colour scheme, dark or light, across all windows. Tint colours the Dock icon to match, handy when you run several windows in different themes."},
