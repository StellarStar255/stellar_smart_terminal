...
TRANSLATIONS = {
    ...
    "window.embed_btn": {"zh": "嵌入", "en": "Embed"},
    "window.embed_tooltip": {"zh": "把导航面板嵌入到每个窗口的左侧栏（与 Explorer/Git/Remote 同一位置）", "en": "Dock the navigator into each window's left panel (same spot as Explorer/Git/Remote)"},
    "window.popout_btn": {"zh": "弹出", "en": "Pop out"},
    "window.popout_tooltip": {"zh": "把导航面板改回独立的浮动窗口", "en": "Detach the navigator back into a floating window"},
