...
from PyQt6.QtCore import Qt, QTimer, QEvent, QPoint, QObject, QSize, QVariantAnimation, QEasingCurve
from PyQt6.QtGui import QAction, QActionGroup, QIcon, QColor, QPixmap, QPainter, QCursor, QKeySequence
...
class MainWindow(ThemeMixin, ToolbarMixin, ConfigMixin, UpdateMixin, QMainWindow):
    """主窗口"""
