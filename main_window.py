...
from PyQt6.QtGui import QAction, QActionGroup, QIcon, QColor, QPixmap, QPainter, QCursor, QShortcut, QKeySequence
...
class MainWindow(ThemeMixin, UpdateMixin, QMainWindow):
    """主窗口"""
