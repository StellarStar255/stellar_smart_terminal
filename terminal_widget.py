...
from PyQt6.QtCore import QThread, pyqtSignal, Qt, QTimer, QEvent, QUrl
...
class TerminalWidget(TerminalInputMixin, TerminalMouseMixin, TerminalRenderMixin, QWidget):
    """
    完整终端模拟器控件
    使用pyte进行终端转义序列处理
    """
